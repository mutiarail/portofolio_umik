   ...
   <main class="team-page-content">
    <section class="team-hero">
        ...
        <div class="team-photo-container">
            <img src="{{ asset('img/LXY26604.JPG') }}" alt="Foto Tim">
        </div>
    ...
    <section class="member-grid">
        ...
        <div class="member-card">
            <img src="{{ asset('img/anggota/verenanda.png') }}" alt="Verenanda" class="member-photo">
        ...
        <div class="member-card">
            <img src="{{ asset('img/anggota/annisa.png') }}" alt="Annisa" class="member-photo">
    ...
    <div class="wrapper">
        <div class="section">
            ...
            <div class="scroll-box">
                ...
                <img src="{{ asset('img/baba_word_2025/poto1.jpeg') }}" alt="foto">
                <img src="{{ asset('img/baba_word_2025/poto3.jpeg') }}" alt="foto">
                <img src="{{ asset('img/baba_word_2025/poto4.jpeg') }}" alt="foto">
                <img src="{{ asset('img/baba_word_2025/poto5.jpeg') }}" alt="foto">
                <img src="{{ asset('img/baba_word_2025/poto6.jpeg') }}" alt="foto">
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="scroll-box">
                ...
                <img src="{{ asset('img/team/2.JPG') }}" alt="foto">
                <img src="{{ asset('img/team/3.JPG') }}" alt="foto">
                <img src="{{ asset('img/team/4.JPG') }}" alt="foto">
                <img src="{{ asset('img/team/5.JPG') }}" alt="foto">
                <img src="{{ asset('img/team/6.JPG') }}" alt="foto">
                <img src="{{ asset('img/team/7.JPG') }}" alt="foto">
                <img src="{{ asset('img/team/8.JPG') }}" alt="foto">
            </div>
        </div>
    </div>  
    ...
    <footer class="main-footer">
        <div class="footer-container">
            <div class="footer-section address">
                <h3>📍 Alamat Kami</h3>
                <a href="https://maps.app.goo.gl/bjocyZ4FNpnUXZxa8" target="_blank" aria-label="Lihat Alamat Kami di Google Maps">
