...
<body>
    ...
    <div class="gallery">
    <img src="{{ asset('img/foto_iren/iren1.jpg') }}" alt="Foto 1">
    <img src="{{ asset('img/foto_iren/iren4.jpg') }}" alt="Foto 1">
    <img src="{{ asset('img/foto_iren/iren3.jpg') }}" alt="Foto 1">
    <img src="{{ asset('img/foto_iren/iren2.jpg') }}" alt="Foto 1">
  </div>
