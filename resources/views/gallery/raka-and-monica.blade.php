...
<body>
    ...
    <div class="gallery">
    <img src="{{ asset('img/foto_raka/raka.jpg') }}" alt="Foto 1">
    <img src="{{ asset('img/foto_raka/raka1.jpg') }}" alt="Foto 1">
    <img src="{{ asset('img/foto_raka/raka2.jpg') }}" alt="Foto 1">
    <img src="{{ asset('img/foto_raka/raka3.jpg') }}" alt="Foto 1">
